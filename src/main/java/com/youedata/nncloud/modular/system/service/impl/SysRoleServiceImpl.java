...
import com.youedata.nncloud.modular.system.dao.RelationMapper;
import com.youedata.nncloud.modular.system.dao.SysRoleMapper;
import com.youedata.nncloud.modular.system.model.Relation;
...
@Service
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, Role> implements IRoleService {
    ...
    public void setAuthority(Integer roleId, String ids) {
        ...
        // 删除该角色所有的权限
        this.sysRoleMapper.deleteRolesById(roleId);
