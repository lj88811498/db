...
public class KaptchaController {
     ...
     */
    @RequestMapping("")
    public void  index(HttpServletRequest request, HttpServletResponse response, String index) {
        ...
        //存到公共map
        GlobalHashMap.setMapCode(index, capText);
    ...
    public void renderPicture(@PathVariable("pictureId") String pictureId, HttpServletResponse response) {
        ...
        try {
            ...
            //如果找不到图片就返回一个默认图片
            try {
                response.sendRedirect("/static/img/person.png");
