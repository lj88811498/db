...
import com.youedata.nncloud.core.common.constant.dictmap.DeptDict;
...
import com.youedata.nncloud.modular.system.warpper.DeptWarpper;
...
public class SysDeptController extends BaseController {
    ...
    public String deptUpdate(@PathVariable Integer deptId, Model model) {
        Dept dept = sysDeptService.selectById(deptId);
    ...
    public List<ZTreeNode> tree() {
        List<ZTreeNode> tree = this.sysDeptService.tree();
    ...
    public Object list(String condition) {
        List<Map<String, Object>> list = this.sysDeptService.list(condition);
    ...
    private void deptSetPids(Dept dept) {
        if (ToolUtil.isEmpty(dept.getPid()) || dept.getPid().equals(0)) {
            ...
            int pid = dept.getPid();
            Dept temp = sysDeptService.selectById(pid);
