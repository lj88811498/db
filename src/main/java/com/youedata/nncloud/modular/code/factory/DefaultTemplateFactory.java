package com.youedata.nncloud.modular.code.factory;


import com.youedata.nncloud.NnCloudApplication;
import com.youedata.nncloud.core.CoreFlag;
...
public class DefaultTemplateFactory {//test
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setProjectPackage(NnCloudApplication.class.getPackage().getName());
