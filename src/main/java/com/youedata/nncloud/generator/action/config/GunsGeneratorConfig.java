package com.youedata.nncloud.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.youedata.nncloud.admin.common.persistence.model");
        packageConfig.setMapper("com.youedata.nncloud.admin.common.persistence.dao");
        packageConfig.setXml("com.youedata.nncloud.admin.common.persistence.dao.mapping");
        packageConfig.setParent(null);

        packageConfig.setEntity("com.youedata.nncloud.dataDir.entity");
        packageConfig.setMapper("com.youedata.nncloud.dataDir.mapper");
        packageConfig.setXml("mapper");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.youedata.nncloud.admin");
        contextConfig.setCoreBasePackage("com.youedata.nncloud.core");
